...
INSERT INTO telefono_cliente (cliente_id, tipo_id, numero) VALUES 
    ...
    (2, 2, '+987654321'),   -- Teléfono del cliente B (Floristería Bella Flor Inc.) con tipo Fijo
    (3, 3, '+1122334455'),  -- Teléfono del cliente C (Plantas y Flores S.A.) con tipo Fax
    (4, 1, '+9988776655'),  -- Teléfono del cliente D (Jardinería Naturaleza Viva Ltda.) con tipo Celular
    (5, 2, '+1122334455'),  -- Teléfono del cliente E (Horticultura Verde y Fresca S.A.) con tipo Fijo
    (6, 3, '+9988776655'),  -- Teléfono del cliente F (Verdor Jardines y Flores S.R.L.) con tipo Fax
    (7, 1, '+1122334455'),  -- Teléfono del cliente G (Floristería Primavera Eterna Ltda.) con tipo Celular
    (8, 2, '+9988776655'),  -- Teléfono del cliente H (Plantas Tropicales y Exóticas S.A.) con tipo Fijo
    (9, 3, '+1122334455'),  -- Teléfono del cliente I (Jardín del Sol y la Luna Ltda.) con tipo Fax
    (10, 1, '+9988776655'); -- Teléfono del cliente J (Flores del Paraíso S.A.) con tipo Celular
...
INSERT INTO telefono_proveedor (proveedor_id, tipo_id, numero) VALUES 
    (1, 1, '+123456789'),   -- Teléfono del proveedor 1 (Jardinería La Rosa Verde) con tipo Celular
    (2, 2, '+987654321'),   -- Teléfono del proveedor 2 (Vivero El Edén) con tipo Fijo
    (3, 3, '+1122334455'),  -- Teléfono del proveedor 3 (Floristería Flores del Sol) con tipo Fax
    (4, 1, '+9988776655'),  -- Teléfono del proveedor 4 (Plantas Tropicales y Exóticas S.A.) con tipo Celular
    (5, 2, '+1122334455'),  -- Teléfono del proveedor 5 (Horticultura Verde y Fresca S.A.) con tipo Fijo
    (6, 3, '+9988776655'),  -- Teléfono del proveedor 6 (Semillas y Plantas El Paraíso) con tipo Fax
    (7, 1, '+1122334455'),  -- Teléfono del proveedor 7 (Vivero El Jardín Encantado) con tipo Celular
    (8, 2, '+9988776655'),  -- Teléfono del proveedor 8 (Plantas y Flores Naturales) con tipo Fijo
    (9, 3, '+1122334455'),  -- Teléfono del proveedor 9 (Jardinería Naturaleza Viva Ltda.) con tipo Fax
    (10, 1, '+9988776655'); -- Teléfono del proveedor 10 (Semillas y Plantas de América) con tipo Celular
